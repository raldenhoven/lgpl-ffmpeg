...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=../external --enable-shared --enable-version3 --arch=x86_64 --cc='cc -m64'
prefix=../external
...
CC_IDENT=Apple clang version 4.1 (tags/Apple/clang-421.11.66) (based on LLVM 3.1svn)
ARCH=x86
CC=cc -m64
CXX=g++
AS=gas-preprocessor.pl cc -m64
LD=cc -m64
DEPCC=cc -m64
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl cc -m64
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
