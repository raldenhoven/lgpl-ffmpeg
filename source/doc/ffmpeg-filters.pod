...
blackframe[=I<amount>[:I<threshold>]].
...
Set the crop area height. It defaults to C<ih>.
This expression is evaluated only once during the filter
configuration.
...
addition to the B<r>, B<g>, B<b> parameters.
...
pairs, separated by ":". If the key of the first options is omitted,
the arguments are interpreted according to the syntax
I<x>:I<y>:I<w>:I<h>:I<rx>:I<ry>:I<edge>:I<blocksize>:I<contrast>:I<search>:I<filename>:I<opencl>.
...
The filters accept parameters as a list of I<key>=I<value> pairs,
separated by ":". If the key of the first options is omitted, the argument is
assumed to be the I<mode>.
...
This filter accepts a single option B<tb>, which can be
specified either by setting B<tb>=I<VALUE> or setting the
value alone.
