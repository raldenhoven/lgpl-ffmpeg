...
#define FFMPEG_CONFIGURATION "--prefix=../external --enable-shared --enable-version3 --arch=x86_64 --cc='cc -m64'"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define FFMPEG_DATADIR "../external/share/ffmpeg"
#define AVCONV_DATADIR "../external/share/ffmpeg"
#define CC_IDENT "Apple clang version 4.1 (tags/Apple/clang-421.11.66) (based on LLVM 3.1svn)"
